...
```shell
gem install ./yousign_client-5.1.2.gem
```
(for development, run `gem install --dev ./yousign_client-5.1.2.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'yousign_client', '~> 5.1.2'
