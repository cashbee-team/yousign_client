...
describe YousignClient::AuthenticationInweboOutput do
  let(:instance) { YousignClient::AuthenticationInweboOutput.new }

  describe 'test an instance of AuthenticationInweboOutput' do
    it 'creates an instance of AuthenticationInweboOutput' do
