...
# Unit tests for YousignClient::OperationInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe YousignClient::OperationInput do
  let(:instance) { YousignClient::OperationInput.new }

  describe 'test an instance of OperationInput' do
    it 'creates an instance of OperationInput' do
      expect(instance).to be_instance_of(YousignClient::OperationInput)
    end
  end
  ...
  describe 'test attribute "all_members"' do
    it 'works' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
