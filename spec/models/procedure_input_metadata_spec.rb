...
describe YousignClient::ProcedureInputMetadata do
  let(:instance) { YousignClient::ProcedureInputMetadata.new }

  describe 'test an instance of ProcedureInputMetadata' do
    it 'creates an instance of ProcedureInputMetadata' do
