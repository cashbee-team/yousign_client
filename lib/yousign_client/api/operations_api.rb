  ...
  class OperationsApi
    ...
    def operations_id_get_with_http_info(id, opts = { })
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError, "Missing the required parameter 'id' when calling OperationsApi.operations_id_get"
      end

      # resource path
      local_var_path = '/operations/{id}'.sub('{id}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        operation:     :'OperationsApi.operations_id_get',
    ...
    def operations_post_with_http_info(body, opts = { })
      ...
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError, "Missing the required parameter 'body' when calling OperationsApi.operations_post"
      end
      ...
      new_options = opts.merge(
        operation:     :'OperationsApi.operations_post',
        header_params: header_params,
        query_params:  query_params,
        form_params:   form_params,
        body:          post_body,
