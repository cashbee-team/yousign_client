  ...
  class SignatureUIsApi
    ...
    def signature_ui_labels_id_delete_with_http_info(id, opts = { })
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SignatureUIsApi.signature_ui_labels_id_delete"
      end
    ...
    def signature_ui_labels_id_get_with_http_info(id, opts = { })
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SignatureUIsApi.signature_ui_labels_id_get"
      end
    ...
    def signature_ui_labels_id_put_with_http_info(id, body, opts = { })
      ...
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
              "Missing the required parameter 'id' when calling SignatureUIsApi.signature_ui_labels_id_put"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling SignatureUIsApi.signature_ui_labels_id_put"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(SignatureUiLabelOutput, Fixnum, Hash)>] SignatureUiLabelOutput data, response status code and response headers
    def signature_ui_labels_post_with_http_info(body, _opts = { })
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling SignatureUIsApi.signature_ui_labels_post"
      end
    ...
    def signature_uis_get_with_http_info(_opts = { })
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(SignatureUiOutput, Fixnum, Hash)>] SignatureUiOutput data, response status code and response headers
    def signature_uis_post_with_http_info(body, _opts = { })
      if @api_client.config.debugging
