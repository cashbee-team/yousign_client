...
require 'yousign_client/models/inline_object'
require 'yousign_client/models/inline_object1'
require 'yousign_client/models/inline_object2'
require 'yousign_client/models/inline_response400'
...
require 'yousign_client/api/signature_uis_api'
